...
public class VehicleController {
    ...
    public ResponseEntity<VehicleDto> updateVehicle(@PathVariable String id, @Valid @RequestBody VehicleDto vehicleDto) {
        return ResponseEntity.ok(vehicleService.updateVehicle(id, vehicleDto));
    }

    @PatchMapping("/vehicles/{id}")
    public ResponseEntity<VehicleDto> patchVehicle(@PathVariable String id, @RequestBody VehicleDto vehicleDto) {
